  ...
  return (
    <>
      ...
      <Desktop>
        <footer className={styles._footer_distributed}>
          <div className={styles._footer_left}>
            <h3>
              Deepak Ku <span> Nayak</span>
            </h3>
            <ul>
              <li> Frontend Developer</li>
              <li>Odisha (Banpur)</li>
              <li>Gmail :- dknayak1329@gmail.com</li>
              <li>Phone :- 7008454980 </li>
        ...
        <h1 className={styles.copywrght}>{new Date().getFullYear()} &copy; copyright Deepak Ku Nayak by </h1>
      </Desktop>
      ...
      <Tablet>
        ...
        <h1 className={styles.copywrghtMid} >{new Date().getFullYear()} &copy; copyright by Deepak Ku Nayak</h1>
      </Tablet>
